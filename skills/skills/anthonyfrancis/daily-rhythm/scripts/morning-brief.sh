...
python3 skills/daily-rhythm/scripts/sync-google-tasks.py 2>/dev/null || echo "  Google Tasks sync skipped"

echo " Syncing Stripe ARR..."
python3 skills/daily-rhythm/scripts/sync-stripe-arr.py 2>/dev/null || echo "  Stripe sync skipped"
