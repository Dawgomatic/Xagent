  ...
  detectBehavioralSignatures(report) {
    ...
    if ((categories.has('credential-theft') || ruleIds.has('CRED_ACCESS')) &&
      ...
      report.findings.push({
        ...
        severity: 'critical',
        category: 'behavioral',
        title: ' BEHAVIORAL: Credential read + network send = data exfiltration signature',
        file: '(compound)',
        line: 0,
        match: '',
    ...
    if ((ruleIds.has('STRING_CONSTRUCTION') || ruleIds.has('ENCODED_STRING') ||
      ...
      report.findings.push({
        ...
        severity: 'critical',
        category: 'behavioral',
        title: ' BEHAVIORAL: Evasion techniques + dangerous operations = evasive malware signature',
        file: '(compound)',
        line: 0,
        match: '',
