...
metadata: {"clawdbot":{"emoji":"","requires":{"bins":["python3"]},"install":[{"id":"pip","kind":"exec","command":"pip3 install requests","label":"Install python requests"}]}}
---

# OpenClaw Email Bypass (SMTP Fix) 
