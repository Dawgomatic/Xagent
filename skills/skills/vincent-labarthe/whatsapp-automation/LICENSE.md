...
**Commercial Use:** Any use that generates revenue or is part of a business model, including:
- Selling the skill
- Offering services using this skill
- Including in paid products
- Using in business operations

**Non-Commercial Use:** Personal, educational, or research use with no financial benefit

---

## Violation

Unauthorized modification, commercial use, or distribution of derivative works is a violation of this license and copyright law.
...
**By using this skill, you agree to these terms.**
