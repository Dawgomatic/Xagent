...
- [ refactor] Platform-agnostic design (works with any multi-agent system) - by sonnet #design
...
- [ refactor] Templates pure English (agent-facing, token-efficient) - by sonnet #design
