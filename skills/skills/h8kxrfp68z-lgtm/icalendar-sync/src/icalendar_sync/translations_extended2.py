...
EXTENDED_TRANSLATIONS_2 = {
    'ko': {
        ...
        'setup_warning': '  일반 Apple ID 비밀번호가 아닌 앱별 비밀번호를 사용하세요.',
        ...
        'event_deleted': '  일정이 성공적으로 삭제되었습니다',
    ...
    'pt': {
        ...
        'setup_warning': '  Use uma Palavra-passe Específica da Aplicação, NÃO a sua palavra-passe normal do Apple ID.',
        ...
        'password_unusual': '  O formato da palavra-passe parece inválido',
        ...
        'keyring_fallback': '  Não foi possível aceder ao porta-chaves do sistema, a usar ficheiro .env',
        ...
        'event_deleted': '  Evento eliminado com sucesso',
        ...
        'warning_conflicts': '  Aviso: {count} evento(s) em conflito encontrado(s):',
        ...
        'input_timeout': '  Tempo limite de entrada',
    ...
    'pt-br': {
        ...
        'setup_warning': '  Use uma Senha Específica do App, NÃO sua senha normal do Apple ID.',
        ...
        'invalid_email': ' Formato de email inválido',
        'continue_anyway': 'Continuar mesmo assim? (s/n): ',
        'password_unusual': '  O formato da senha parece inválido',
        ...
        'keyring_fallback': '  Não foi possível acessar o chaveiro do sistema, usando arquivo .env',
