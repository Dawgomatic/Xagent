...
EXTENDED_TRANSLATIONS = {
    'zh-cn': {
        ...
        'setup_warning': '  请使用应用专用密码，不是您的常规 Apple ID 密码。',
        ...
        'warning_conflicts': '  警告：发现 {count} 个冲突事件：',
    ...
    'zh-tw': {
        ...
        'setup_warning': '  請使用應用程式專用密碼，而不是您的一般 Apple ID 密碼。',
        ...
        'warning_conflicts': '  警告：發現 {count} 個衝突事件：',
        'warning_conflict_item': '   - {summary} ({start} 到 {end})',
    ...
    'ja': {
        ...
        'setup_warning': '  通常の Apple ID パスワードではなく、App 用パスワードを使用してください。',
