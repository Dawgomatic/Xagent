...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    'en': {
        ...
        'setup_warning': '  Use an App-Specific Password, NOT your regular Apple ID password.',
        ...
        'password_unusual': '  Password format looks unusual',
        ...
        'keyring_fallback': '  Could not access system keyring, falling back to .env file',
        ...
        'warning_conflicts': '  Warning: {count} conflicting event(s) found:',
    ...
    'ru': {
        ...
        'setup_warning': '  Используйте пароль для приложения, НЕ обычный пароль Apple ID.',
        ...
        'password_unusual': '  Формат пароля выглядит необычно',
        ...
        'keyring_fallback': '  Не удалось получить доступ к связке ключей, используется файл .env',
        ...
        'warning_conflicts': '  Предупреждение: найдено {count} конфликтующих событий:',
        ...
        'input_timeout': '  Время ожидания ввода истекло',
    ...
    'nl': {
        ...
        'setup_warning': '  Gebruik een App-specifiek wachtwoord, NIET uw gewone Apple ID-wachtwoord.',
        ...
        'password_unusual': '  Wachtwoordformaat ziet er ongebruikelijk uit',
        ...
        'keyring_fallback': '  Kon geen toegang krijgen tot systeemsleutelhanger, gebruik .env-bestand',
        ...
        'event_deleted': '  Gebeurtenis succesvol verwijderd',
        ...
        'warning_conflicts': '  Waarschuwing: {count} conflicterende gebeurtenis(sen) gevonden:',
    ...
    'sv': {
        ...
        'setup_warning': '  Använd ett App-specifikt lösenord, INTE ditt vanliga Apple ID-lösenord.',
        ...
        'password_unusual': '  Lösenordsformatet ser ovanligt ut',
        ...
        'keyring_fallback': '  Kunde inte komma åt systemnyckelring, använder .env-fil',
        ...
        'event_deleted': '  Händelse raderad framgångsrikt',
        ...
        'warning_conflicts': '  Varning: {count} konflikterande händelse(r) hittades:',
        ...
        'input_timeout': '  Inmatnings-timeout',
    ...
    'fi': {
        ...
        'setup_warning': '  Käytä sovellukselle tarkoitettua salasanaa, ÄLKÄÄ tavallista Apple ID -salasanaa.',
        ...
        'password_unusual': '  Salasanan muoto näyttää epätavalliselta',
        ...
        'keyring_fallback': '  Järjestelmän avainnippuun pääsy epäonnistui, käytetään .env-tiedostoa',
        ...
        'event_deleted': '  Tapahtuma poistettu onnistuneesti',
    ...
    'da': {
        ...
        'setup_warning': '  Brug en App-specifik adgangskode, IKKE din almindelige Apple ID-adgangskode.',
        ...
        'password_unusual': '  Adgangskodeformat ser usædvanligt ud',
        ...
        'keyring_fallback': '  Kunne ikke få adgang til systemnøglering, bruger .env-fil',
        ...
        'event_deleted': '  Begivenhed slettet med succes',
        ...
        'warning_conflicts': '  Advarsel: {count} konfliktende begivenhed(er) fundet:',
    ...
    'uk': {
        ...
        'setup_warning': '  Використовуйте пароль для застосунку, НЕ звичайний пароль Apple ID.',
        ...
        'password_unusual': '  Формат пароля виглядає незвично',
        ...
        'keyring_fallback': '  Не вдалося отримати доступ до зв\'язки ключів, використовується файл .env',
        ...
        'event_deleted': '  Подія успішно видалена',
        ...
        'warning_conflicts': '  Попередження: знайдено {count} конфліктуючих подій:',
        'warning_conflict_item': '   - {summary} ({start} до {end})',
        'confirm_continue': 'Продовжити все одно? (y/n): ',
        'creation_cancelled': 'Створення події скасовано',
        'input_timeout': '  Час очікування введення минув',
...
TRANSLATIONS['es'] = {
    ...
    'setup_warning': '  Usa una Contraseña Específica de App, NO tu contraseña regular de Apple ID.',
    ...
    'password_unusual': '  El formato de contraseña parece inusual',
    ...
    'keyring_fallback': '  No se pudo acceder al llavero del sistema, usando archivo .env',
    ...
    'warning_conflicts': '  Advertencia: {count} evento(s) en conflicto encontrado(s):',
    ...
    'input_timeout': '  Tiempo de espera agotado',
