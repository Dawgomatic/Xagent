...
async function runTests() {
  try {
    ...
    console.log('  Test: Basic remember/recall');
    ...
    console.log('  Test: Update existing memory');
    ...
    console.log('  Test: Multiple memories');
    ...
    console.log('  Test: List memories');
    ...
    console.log('  Test: Forget (delete)');
    await forget('test/multi/item2');
    console.log(`     Deleted test/multi/item2`);
    ...
    // Test 7: Large text
    console.log('  Test: Large text storage');
    ...
    console.log('  Test: Recall non-existent key');
