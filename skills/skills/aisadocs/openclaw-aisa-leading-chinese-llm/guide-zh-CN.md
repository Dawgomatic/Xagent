...
>  以下所有定价仅供参考，实时价格以 AIsa 官方为准：https://marketplace.aisa.one/pricing
...
** 重要限制：** Kimi K2.5 **只接受 `temperature=1.0`**，使用其他值会返回错误：
```
...
### 模型 ID 版本说明
 ...
 AIsa 的某些模型使用带日期或特殊的版本 ID。如果遇到 `503 - No available channels` 错误，请参考以下对照表：
