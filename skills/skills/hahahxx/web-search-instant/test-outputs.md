...
### API Limitations
-  Some queries don't have instant answers (expected behavior)
-  Complex math functions may not work (sqrt(), etc.)
-  Definitions may not always return instant results
...
2.  Document API limitations in skill description
