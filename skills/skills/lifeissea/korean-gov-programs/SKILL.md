...
| 소상공인시장진흥공단(SEMAS) | 소상공인 | JS 렌더링 필요 |  스킵 |
| 중소벤처기업부(MSS) | 정부지원 | JS 렌더링 필요 |  스킵 |
| K-Startup | 창업지원 | JS 렌더링 필요 |  스킵 |
| 연구개발특구진흥재단(Innopolis) | R&D | JS 렌더링 필요 |  스킵 |
| 창업진흥원(KISED) | 창업 | eGovFrame 오류 |  스킵 |
