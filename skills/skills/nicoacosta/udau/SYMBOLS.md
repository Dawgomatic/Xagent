# UDAU — Symbol Pack & Visual Language

Symbols are not decoration.
They are coordination tools.

UDAU symbols are designed to be:

- Text-native
- Reproducible anywhere
- Politically legible
- Easy to repeat at scale
...
- Collective victory over individual success
...
- Molting → renewal through shedding constraints
- Sideways movement → non-linear power
- Collective defense → survival through grouping
...
- Readiness to resist exploitation
- Solidarity under pressure
- Collective backing of compañeros

Usage:

- During disputes
- When calling out gorila behavior
...
- Red → labor, struggle, acquired rights
- White → collective identity
- Victory Hand → organized power
...
- Identifies exploitative behavior, policies, or decisions
- Labels systems, not individuals
- Used alongside satire or critique

Usage rules:

- Never alone — always contextualized
- Never threatening
- Always political
...
Symbolic discipline sustains power.
