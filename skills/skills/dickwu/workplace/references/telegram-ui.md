...
| ` Continue: {label}` | Set as active session, resume |
...
```json
{
  "blocks": [
    ...
    {"type": "buttons", "buttons": [
      {"label": " Continue: rust refactor", "style": "primary"},
      {"label": " Continue: bug fixes", "style": "secondary"}
    ]},
    {"type": "buttons", "buttons": [
...
When user clicks " Continue: {label}":
...
```
 Resuming **rust refactor** for **logstream**
Last active: 2h ago
```
...
```json
{
  "blocks": [
    {"type": "buttons", "buttons": [
      {"label": " rust refactor", "style": "secondary"},
      {"label": " bug fixes", "style": "secondary"}
    ]},
    {"type": "buttons", "buttons": [
...
- " {label}": rename that session (prompt for new label)
...
| ` Manage sessions` | Show session management view |
| ` {label}` | Prompt to rename session |
