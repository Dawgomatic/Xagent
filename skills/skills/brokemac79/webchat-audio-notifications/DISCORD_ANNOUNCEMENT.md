...
**What it does:**
- Plays notification sounds when new messages arrive (only when tab is in background)
- 5 intensity levels: whisper → impossible to miss
- Upload your own custom sounds (MP3, WAV, OGG, WebM)
...
- Which sound level do you prefer?
- Any bugs or issues?
- Feature requests?

**Supported browsers:**
Chrome, Firefox, Safari, Edge (92% coverage)

**Tech:**
- Pure JavaScript (no framework)
- Howler.js for audio
- localStorage for preferences
- ~200KB total (cached after first load)
...
3. Any browser compatibility issues?
4. Would you use the custom sound upload?
5. Is the setup documentation clear enough?

**For developers:**
1. Would you integrate this into your webchat?
