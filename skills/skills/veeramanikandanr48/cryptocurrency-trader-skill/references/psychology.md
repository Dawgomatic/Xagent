...
Result: Miss good opportunities
```
...
- Reality: Next $500 loss is independent of first $500
```
...
Result: Big loss that wipes out 5 wins
```
...
Reality: Long history of 80% drawdowns
```
...
Reality: $60K is arbitrary, market doesn't care
```
...
Result: Hold losing position too long
```
...
- Past losses don't increase future win odds
```
...
- $1000 profit = $1000, same as salary $1000
```
...
Reality: Can take years (2018 crypto winter)
```
...
**Based on:** Academic research in behavioral finance and trading psychology
