...
-  KOL Updates (Twitter KOLs — each entry MUST include source tweet URL and engagement metrics. Format: `• **@handle** — summary \` 12.3K |  45 |  230 |  1.2K\`\n  <https://twitter.com/handle/status/ID>`)
