...
>  "Set up a weekly Hollywood digest, only box office and awards, deliver to Discord #awards every Monday"

>  "Install media-news-digest, add my RSS feeds, and send festival news to email"

>  "Give me a media digest right now, focus on streaming news"
